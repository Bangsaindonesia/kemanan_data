...
class CaesarCipherApp:
    ...
    def setup_enkripsi_tab(self):
        ...
        self.create_gradient_background(canvas, "#0f2027", "#2c5364")

        tk.Label(canvas, text="Jumlah Pergeseran:", bg="#0f2027", fg="#ffffff", font=("Arial", 10, "bold")).place(x=40, y=40)
        shift_spinbox = ttk.Spinbox(canvas, from_=1, to=25, width=5, textvariable=self.shift_value)
        shift_spinbox.place(x=160, y=40)

        tk.Label(canvas, text="Masukkan Plainteks:", bg="#0f2027", fg="#ffffff", font=("Arial", 10, "bold")).place(x=40, y=130)
        self.plaintext_input = self.create_textbox_with_border(canvas, 40, 150, 540, 220)

        tk.Button(canvas, text="Enkripsi", command=self.encrypt, bg="#393e46", fg="#ffffff", font=("Arial", 10, "bold"), relief="flat").place(x=260, y=250)

        tk.Label(canvas, text="Hasil Enkripsi (Cipherteks):", bg="#0f2027", fg="#ffffff", font=("Arial", 10, "bold")).place(x=40, y=310)
    ...
    def setup_dekripsi_tab(self):
        ...
        tk.Label(canvas, text="Masukkan Cipherteks:", bg="#0f2027", fg="#ffffff", font=("Arial", 10, "bold")).place(x=40, y=130)
        self.cipher_input = self.create_textbox_with_border(canvas, 40, 150, 540, 220)

        tk.Button(canvas, text="Dekripsi", command=self.decrypt, bg="#393e46", fg="#ffffff", font=("Arial", 10, "bold"), relief="flat").place(x=260, y=250)

        tk.Label(canvas, text="Hasil Dekripsi (Plainteks):", bg="#0f2027", fg="#ffffff", font=("Arial", 10, "bold")).place(x=40, y=310)
